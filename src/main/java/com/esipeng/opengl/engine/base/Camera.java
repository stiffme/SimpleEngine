...
class Camera {
    private Vector3f m_cameraPos, m_cameraFront, m_camaraUp, m_vecTemp;
    private Matrix4f m_matLookAt = new Matrix4f();
    private float[] m_matBuf = new float[16], m_vecBuf = new float[3];
    private float speedPerMilisecond = 2.5f;
    private float m_lastX = 400, m_lastY = 300;
    private long m_window;
    private float m_pitch = 0, m_yaw = -90f;
